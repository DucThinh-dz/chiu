...
const fullText1 = splitLines("ní hảo  gong zhu", 3);
const fullText2 = splitLines("chúc chị YẾN luôn xinh đẹp rạng rỡ nhó", 3);
const fullText3 = splitLines("VALENTINE ZUI ZẺ", 3);
